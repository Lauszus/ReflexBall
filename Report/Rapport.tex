...
%		\input{tex/maple}
		...
		\input{tex/Specifikationer}
		\input{tex/Plan}
		\input{tex/Struktur}
		\input{tex/Verifikation}
		\input{tex/Brugermanual}
		\input{tex/Diskussion}
		\input{tex/Konklusion}
		
	%%%	Appendix %%%		
		\newpage\appendix
		\input{texAppendiks/IntroOpgaver}
		\input{texAppendiks/Javakoder}
		\input{texAppendiks/Ckoder}
%%%%%%%%%%%%%%%%%%%%%%%%
%%% THE BIBLIOGRAPHY %%%
%%%%%%%%%%%%%%%%%%%%%%%%
